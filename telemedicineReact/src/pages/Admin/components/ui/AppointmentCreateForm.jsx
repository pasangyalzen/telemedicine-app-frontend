...
const AppointmentCreateForm = ({ handleCreateAppointment, handleSubmit, cancelCreateForm, formData, setFormData, handleStatusChange }) => {

  // Sync local state with `formData` when modal opens
  useEffect(() => {
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          <AppointmentStatusSelect
            ...
            onChange={(e) => setFormData({ ...formData, status: e.target.value })} // Directly updating the formData
            required
        ...
        <div className="flex justify-end gap-4 mt-4">
          <Button type="submit" className="bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition duration-300">
            Create
          </Button>
          <Button
            type="button"
