    ...
    return (
        <div className={`h-screen ${isCollapsed ? "w-16" : "w-64"} bg-primary-dark text-[#65cccc] flex flex-col transition-all duration-300`}>
        {/* Sidebar Header */}
        <div className="p-4 flex justify-between items-center border-b border-gray-700">
            {!isCollapsed && <h1 className="text-2xl font-bold">TELECHAUKI</h1>}
            <button onClick={() => setIsCollapsed(!isCollapsed)} className="text-[#65cccc] bg-primary-light hover:text-white hover:bg-[#49cccc]">
        ...
        <div className="p-4 border-t border-gray-700">
            <button className="w-full flex items-center justify-center p-3 bg-[#49cccc] text-primary-dark rounded-lg hover:bg-[#49ccccd7] hover:text-white transition">
